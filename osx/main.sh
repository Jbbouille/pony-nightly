...
curl -T ponyc-$PONY_VERSION.tar.gz -u$BINTRAY_USER:$BINTRAY_TOKEN -H "X-Bintray-Publish: 1" https://api.bintray.com/content/$BINTRAY_USER/osx/ponyc-nightly/$PONY_VERSION/
if [[ $? -ne 0 ]]; then
